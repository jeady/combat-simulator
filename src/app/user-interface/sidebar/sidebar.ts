...
export class Sidebar extends HTMLElement {
    ...
    private readonly _autoOptimize: HTMLButtonElement;
    ...
    constructor() {
        ...
        this._autoOptimize = getElementFromFragment(this._content, 'mcs-auto-optimize-sidebar', 'button');
    ...
    public connectedCallback() {
        ...
        this._autoOptimize.onclick = () => PageController.goTo(PageId.AutoOptimize);
